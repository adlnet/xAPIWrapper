...
function setupCourseLinks(_nodes) {console.log("HERE");
...
function xAPILaunch(cb, terminate_on_unload) {
    ...
    try
    {
        ...
        xAPILaunch.terminate = function(message) {
            // let launch2 = ADL.Util.parseURL(launchEndpoint);
        ...
        xhr.onload = function(e) {console.log(xhr);
            if (xhr.status !== 200)
            {
