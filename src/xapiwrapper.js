let onBrowser = (typeof module !== 'undefined') ? false : true;
...
(function(){
  ...
  class XAPIWrapper {
              ...
              r => {
                  if(r.status == 200)
                  {
                      try
                      {
                          ...
                          if (!versionOK)
                          {
                              this.log(`The lrs version [${lrsabout.version}] does not match this wrapper's XAPI version [${this.xapiVersion}]`);
                          }
                      }
                      catch(e)
                      {
    ...
    changeConfig(config){
        try
        {
            this.log("updating lrs object with new configuration");
...
console.log(id);
            ...
            let resp = this.XHR_request(this.lrs, `${this.lrs.endpoint}statements`,
    ...
    */
    ...
    //         }
    //         let resp = ADL.XHR_request(this.lrs,`${this.lrs.endpoint}statements`,
    ...
    //         }
    //
    //         let res = ADL.XHR_request(this.lrs,url, "GET", null, this.lrs.auth, callback,null,false,null,this.withCredentials, this.strictCallbacks);
    //
    ...
    // };
    //
    // XAPIWrapper.prototype.getMoreStatements = function (iterations, callback, searchParams) {
    ...
    //
    //         let result = ADL.XHR_request(this.lrs, url, "GET", null, this.lrs.auth, callback, null, true,null,this.withCredentials, this.strictCallbacks);
    //
    ...
    //
    //         let headers = null;
    //         let result = ADL.XHR_request(this.lrs, url, "DELETE", null, this.lrs.auth, callback, null, false, headers, this.withCredentials, this.strictCallbacks);
    //
    //         if(result === undefined || result.status == 404)
    //         {
    //             return null
   ...
   * };
   */
  let xhrRequestOnError = function(xhr, method, url, callback, callbackargs, strictCallbacks){
  ...
  module.exports = exports = new XAPIWrapper(Config, false);
