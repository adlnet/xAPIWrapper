(function(ADL){
    ...
    function xAPILaunch(callback, terminate_on_unload, strict_callbacks)
    {
        var cb = cb_wrap(callback);
        try
        {
            var launchToken = getQueryVariable("xAPILaunchKey");
            var launchEndpoint = getQueryVariable("xAPILaunchService");
     ...
     * @param {boolean} terminate_on_unload
     * @param {boolean} strict_callbacks
     */
